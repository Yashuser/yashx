    ...
    <PageLayout>
      <ContentBox>
        ...
        <div className="space-y-6 text-muted-foreground">
          ...
          <div>
            <h2 className="text-2xl font-semibold text-foreground mb-4">World generation</h2>
            <p className="text-base leading-relaxed">
          ...
          <div>
            <h2 className="text-2xl font-semibold text-foreground mb-4">Gameplay Changes</h2>
          ...
          <div>
            <h2 className="text-2xl font-semibold text-foreground mb-4">Server Features</h2>
            <ul className="list-disc list-inside space-y-3 ml-4">
