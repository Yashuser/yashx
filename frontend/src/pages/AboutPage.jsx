    ...
    <PageLayout>
      <ContentBox>
        ...
        <div className="space-y-4 sm:space-y-6 text-muted-foreground">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">What is Anarchy?</h2>
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">Server History</h2>
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">Community</h2>
            <p className="text-sm sm:text-base leading-relaxed">
